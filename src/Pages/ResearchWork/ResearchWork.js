        ...
        <div className='ResearchWork'>
            <div className="section">
                ...
                <div className="Phd-Thesis-Title">
                    ...
                    <a href="http://gyan.iitg.ernet.in/handle/123456789/1663" className='link'>
                        Multi-Level Dimension Decomposition Approach for Structural Reliability Analysis (pdf)
                    </a>
                </div>
            ...
            <div className="section">
                ...
                <div className="students">
                    <div className="student">
                        <img className="photo" src="http://home.iitj.ac.in/~akrathi/img/profile/Santosh_Bisoyi_PhD_April2022.jpg" alt="" />
                    ...
                    <div className="student">
                        ...
                        <img className="photo" src="http://home.iitj.ac.in/~akrathi/img/profile/Sahil_Rana_PhD_April2022.jpeg" alt="" />
                        <div className="PhD-info">
                            <div className="name">
                                Sahil Rana
                            </div>
            ...
            <div className="section">
                ...
                <div className="students">
                    <div className="student">
                        <img className="photo" src="http://home.iitj.ac.in/~akrathi/img/profile/Amar_Kumar_MTech_April2022.jpg" alt="" />
